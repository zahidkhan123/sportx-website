...
export default function SignupStep2Page() {
  ...
  // Debug: Log when countries change
  useEffect(() => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-black p-4">
      <Card className="glass-card w-full max-w-2xl border-white/10">
        <CardHeader>
          ...
          <p className="text-white/70 text-center">Step 2 of 2: Profile Details</p>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 p-4 bg-white/5 rounded-lg border border-white/10">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full bg-[#00FFFF] text-black hover:bg-[#00FFFF]/90 disabled:opacity-50"
            >
              {loading ? (
                <>
